    ...
    <body>
        ...
        <section class="section__container booking__container">
            <div class="booking__nav">
                <span><a href="flyarystan.php" target="_blank">Билет</a></span>
        ...
        <form>
                ...
                <span><i class="ri-map-pin-line"></i></span>
                    <div class="input__content">
                        <div class="input__group">
                            <input type="text" class="input-field" placeholder="Откуда" name="from_location">
                        </div>
                    </div>
            </div>
            <div class="form__group">
                <span><i class="ri-map-pin-line"></i></span>
                    <div class="input__content">
                        <div class="input__group">
                            <input type="text" class="input-field" placeholder="Куда" name="to_location">
                        </div>
            ...
            <div class="form__group">
                ...
                <div class="input__content">
                    <div class="input__group">
                        <input type="date" id="departureDate" class="input-field" placeholder="Дата туда" name="date">                   
                    </div>
                </div>
            </div>
            <div class="btn" name="submit"><a href="tickets.php" target="_blank"><i class="ri-search-line"></a></i></div>
