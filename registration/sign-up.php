    ...
    <body>
        ...
        <div class="login-box">
            <div class="login-header">
                <header>Join FlyArystan Loyalty Program for Free</header>
            </div>
            <div class="info">
        ...
        <?php
            ...
            <form action="sign-up.php" method="post">
                ...
                <div class="login-grid">
                    ...
                    <div class="input-box">
                        <p>Phone Number*</p>
                        <input type="text" class="input-field" name="number" placeholder="+7">
                    </div>
                </div>
                <div class="login-grid">
                    <div class="input-box">
            ...
            <div class="sign-up-link">
                <p>Already a member?  <a href="sign-in.php" target="_blank">Log in</a></p>
            </div>
        </div>
    </body>
</html>